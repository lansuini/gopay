$(function() {
    common.getAjax("/api/" + "basedata?requireItems=payType", function(a) {
        $("#selPayType").initSelect(a.result.payType, "key", "value", "支付方式");

        $("#btnSearch").initSearch(apiPath + "payamount", getColumns(), {
            success_callback: buildSummary
        });
        $("#btnExport").bind('click',function () {
            $("#btnExport").initExport(apiPath + "payamount", getColumns(), {})
        })
    });
