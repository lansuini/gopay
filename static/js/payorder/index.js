var payOrderStatus,payType,payChannel
$(function() {
    common.getAjax(apiPath + "basedata?requireItems=payOrderStatus,payType,channel", function(a) {
        payOrderStatus = a.result.payOrderStatus
        payType = a.result.payType
        payChannel = a.result.channel
...
function getColumns() {
    return [{
       ...
       /* {
        ...
        align: "center",
        formatter: function(b, c, a) {
            payChannel.forEach(function(item){
