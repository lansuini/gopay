var settlementOrderStatus,bankCode
$(function() {
    common.getAjax(apiPath + "basedata?requireItems=settlementOrderStatus,bankCode", function(a) {
        settlementOrderStatus = a.result.settlementOrderStatus
...
function getColumns() {
    return [{
        ...
        align: "center",
        formatter: function(b, c, a) {
            settlementOrderStatus.forEach(function(item){
...
function buildSummary(k) {
    if (k && k.success && k.rows &&  k.rows.length > 0 ) {
        var b = k.stat;
        /* var b = 0; */
        var f = {
            Exception: {
