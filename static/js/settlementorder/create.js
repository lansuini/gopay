$(function() {
    common.getAjax(apiPath + "basedata?requireItems=bankCode", function(a) {
...
function showConfirmModal() {
    ...
    document.getElementById("spanOrderAmount").innerText = $("#txtOrderAmount").val();
    document.getElementById("spanBankCode").innerText = $("#selBankCode option:selected").html();
    document.getElementById("spanBankAccountNo").innerText = $("#txtBankAccountNo").val();
    document.getElementById("spanBankAccountName").innerText = $("#txtBankAccountName").val();
    document.getElementById("spanProvince").innerText = $("#txtProvince").val();
    document.getElementById("spanCity").innerText = $("#txtCity").val();
    document.getElementById("spanBankDistrict").innerText = $("#txtDistrict").val();
    document.getElementById("spanOrderReason").innerText = $("#txtOrderReason").val();
...
function submit() {
    ...
    myConfirm.show({
        ...
        sure_callback: function() {
            common.postJson("settlementorder/create","divContainer",function(d) {
