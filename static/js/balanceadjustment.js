var bankrollType, bankrollDirection, commonStatus2
$(function() {
    common.getAjax(apiPath + "basedata?requireItems=bankrollType,bankrollDirection,commonStatus2", function(a) {
        apiPath += "merchant/balanceadjustment";
        bankrollType = a.result.bankrollType
        bankrollDirection = a.result.bankrollDirection
        commonStatus2 = a.result.commonStatus2
    ...
    // common.getAjax(apiPath + "merchant/getbasedata", function (a) {
...
function getColumns() {
    return [{
        ...
        align: "center",
        formatter: function(b, c, a) {
            bankrollType.forEach(function(item){
                if(item.key === c.bankrollType){
                    b = item.value
                    return item.value
                }
            });
        ...
        align: "center",
        formatter: function(b, c, a) {
            bankrollDirection.forEach(function(item){
                if(item.key === c.bankrollDirection){
                    b = item.value
                    return item.value
                }
            });
        ...
        align: "center",
        formatter: function(b, c, a) {
            commonStatus2.forEach(function(item){
...
function showEditModal(a) {
    ...
    common.getAjax("api/merchant/random",function (e) {
        if(e.success) {
...
function submit() {
    ...
    common.postJson("", "editModal", function(a) {
        if (a.success == 1) {
            myAlert.success("操作成功！", undefined, function() {
