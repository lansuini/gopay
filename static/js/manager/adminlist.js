$(function () {
    common.getAjax(apiPath + "basedata?requireItems=systemAccountRoleCode,systemAccountstatusCode", function (a) {
        apiPath += "manager/";
        ...
        $("#btnSearch").initSearch(apiPath + "adminlist", getColumns());
    });
